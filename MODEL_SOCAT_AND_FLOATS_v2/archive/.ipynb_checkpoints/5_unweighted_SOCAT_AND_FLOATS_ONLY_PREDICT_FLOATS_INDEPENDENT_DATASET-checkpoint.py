...
# Ensemble Models (100 models = 10 architectures × 10 MC runs)
...
# Paths (UNCHANGED)
# ---------------------------------------------------------------
BASE_PATH = "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_FLOATS_v2/processing_steps/independent_validation/"
MC_model_dir = "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_SOCAT_AND_FLOATS_v2/models/unweighted/MC_ensemble/"

indep_data_path = BASE_PATH + "pco2_independent_validation_data_TSMLD_SLA_RRS_PAR_WIND_ATM_CO2_feature_engineered_monthly_1deg.csv"

# Scaler is shared with training (PATH KEPT AS YOU PROVIDED)
scaler_path = os.path.join(
    "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_SOCAT_AND_FLOATS_v2/models/unweighted/",
    "trained_scaler.joblib"
)

output_csv = f"{MC_model_dir}/FLOATS_independent_predictions/MC_unweighted_FLOATS_independent_validation_predictions.csv"
...
if "FLOATS_temperature_median" in indep_df.columns:
    rename_map["FLOATS_temperature_median"] = "temperature"

if "FLOATS_salinity_median" in indep_df.columns:
    rename_map["FLOATS_salinity_median"] = "salinity"
