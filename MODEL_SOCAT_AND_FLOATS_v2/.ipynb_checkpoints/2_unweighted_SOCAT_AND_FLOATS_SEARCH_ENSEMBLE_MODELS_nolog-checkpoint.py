...
# Unweighted Huber Loss, SOCAT Validation Constraint, Early Stopping
# NO LOG TRANSFORM – SYMMETRIC TREATMENT OF SOCAT + FLOATS
...
model_output_dir = "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_SOCAT_AND_FLOATS_v2/models/unweighted/"
...
train_df = pd.read_csv(BASE_PATH + "pco2_train_data.csv")     # SOCAT + FLOATS mixed
...
# ===============================================================
# Extract X, y (NO WEIGHTS ANYMORE)
# ===============================================================
...
# ===============================================================
# Loss Function – UNWEIGHTED HUBER
# ===============================================================
...
for idx, (l1, l2, l3) in enumerate(search_space, start=1):
    ...
    for epoch in range(max_epochs):
        ...
        for xb, yb in train_loader:
            optimizer.zero_grad()
            pred = model(xb)
            loss = criterion(pred, yb)   # UNWEIGHTED LOSS
            loss.backward()
            optimizer.step()
