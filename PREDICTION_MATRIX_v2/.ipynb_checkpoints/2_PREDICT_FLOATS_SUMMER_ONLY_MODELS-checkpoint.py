# ============================================================
# === Predict pCO₂ from MATRIX Using FLOATS MC Ensemble (GELU)
# ============================================================
...
MC_model_dir = "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_FLOATS_SUMMER_ONLY_v2/models/30S/MC_ensemble/"
...
trained_scaler_path = "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_FLOATS_SUMMER_ONLY_v2/models/30S/trained_scaler.joblib"

output_csv = "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/PREDICTION_MATRIX_v2/matrix_predictions/pco2_prediction_matrix_FLOATS_SUMMER_only_MCensemble.csv"
...
rename_map = {
    "ARMOR3D_temperature": "FLOATS_temperature_median",
    "ARMOR3D_salinity": "FLOATS_salinity_median"
}
...
# ============================================================
# === 4. DEFINE FLOATS MLP LOADER (GELU) ====================
# ============================================================
...
# Hard defragment before saving large files
df = df.copy()
