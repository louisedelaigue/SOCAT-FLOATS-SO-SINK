# ===============================================================
# PM–MLD–SLA–RRS Monthly Merge on 1° Grid (Aligned to 0.5° Centers)
# Louise Delaigue – 2025
# ===============================================================

"""
Merges the PM–MLD–SLA (1° × monthly) dataset with Copernicus Ocean Colour
Remote Reflectance (RRS) data for the Southern Ocean (-90° to -30°).

Steps:
 1. Load PM–MLD–SLA 1°×1° monthly dataset
 2. Regrid Copernicus RRS bands (0.04° daily) to 1° monthly (median per cell)
 3. Merge RRS with the PM–MLD–SLA grid
"""
import os
...
# === Paths ===
PM_sla_path = (
"/home/ldelaigue/Documents/Python/SOCAT-OSSE-SO/PREDICTION_MATRIX_v2/"
    "processing_steps/ARMOR3D_TSMLD_SouthernOcean_1997_2024_monthly_1deg_SLA.csv"
)
output_path = (
    "/home/ldelaigue/Documents/Python/SOCAT-OSSE-SO/"
    "PREDICTION_MATRIX_v2/processing_steps/"
    "ARMOR3D_TSMLD_SouthernOcean_1997_2024_monthly_1deg_SLA_RRS.csv"
)
...
# ===============================================================
# 1. Load PM–MLD–SLA monthly grid
# ===============================================================
print("Loading PM–MLD–SLA dataset...")
df_all = pd.read_csv(PM_sla_path)
...
for var in variables_all:
    ...
    for year in years:
        ...
        # --- Merge RRS with PM–MLD–SLA grid ---
        df_year = pd.merge(
            df_year,
            df_rrs,
