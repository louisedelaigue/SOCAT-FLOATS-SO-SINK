# ===============================================================
# PM–MLD–SLA–RRS–PAR–ERA5 Wind (Full Dataset, 1° Grid)
# Louise Delaigue – 2025
# ===============================================================

"""
Full pipeline for merging ERA5 10 m wind fields (u10, v10, wind_speed)
onto the 1°×1° monthly PM–MLD–SLA–RRS–PAR grid.
...
PM_par_path = (
    ...
    "ARMOR3D_TSMLD_SouthernOcean_1997_2024_monthly_1deg_SLA_RRS_PAR.csv"
)
wind_nc_path = (
...
output_path = (
    "/home/ldelaigue/Documents/Python/SOCAT-OSSE-SO/"
    "PREDICTION_MATRIX_v2/processing_steps/"
    "ARMOR3D_TSMLD_SouthernOcean_1997_2024_monthly_1deg_SLA_RRS_PAR_WIND.csv"
)
...
# ===============================================================
# 1. Load PM–MLD–SLA–RRS–PAR grid
# ===============================================================
print("Loading PM–MLD–SLA–RRS–PAR dataset...")
df_all = pd.read_csv(PM_par_path)
...
print(f"Loaded {len(df_all):,} PM grid cells")
...
# ===============================================================
# 4. Merge with PM grid
# ===============================================================
print("Merging ERA5 with PM grid...")
...
print(f"\nMatched {matched:,} of {total:,} PM grid cells ({pct:.2f}%)")
