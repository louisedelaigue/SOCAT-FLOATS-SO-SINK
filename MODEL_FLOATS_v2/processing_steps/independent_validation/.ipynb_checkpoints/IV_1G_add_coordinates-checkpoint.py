# ===============================================================
# Feature Engineering for FLOATS fCO₂ Modeling (Pipeline Version)
# Louise Delaigue – 2025
# ===============================================================

"""
Loads the fully merged FLOATS 1°×1° monthly dataset
(FLOATS + MLD + SLA + RRS + PAR + WIND + ATM CO₂)
and computes engineered features:
...
# ===============================================================
output_path = ("/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_FLOATS_v2/processing_steps/independent_validation/pco2_independent_validation_data_TSMLD_SLA_RRS_PAR_WIND_ATM_CO2_feature_engineered_monthly_1deg.csv")
