...
# Ensemble Models (1000 models = 10 architectures × 100 MC runs)
# For FLOATS-based Model
...
MC_model_dir = (
    ...
    "MODEL_FLOATS_v2/models/30S/MC_ensemble/"
)
...
scaler_path = (
    "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/"
    "MODEL_FLOATS_v2/models/30S/trained_scaler.joblib"
)

output_csv = f"{MC_model_dir}/independent_predictions/MC_FLOATS_independent_validation_predictions.csv"

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
print(f"[INFO] Using device: {device}")

# ---------------------------------------------------------------
# Required pipeline input columns (MATCH RANDOM SEARCH + MC TRAINING)
# ---------------------------------------------------------------
input_columns = [
...
# ---------------------------------------------------------------
# 5. Define MLP Loader (MATCH TRAINING: GELU)
# ---------------------------------------------------------------
...
for idx, model_file in enumerate(model_files):
    ...
    # Parse layer sizes from filename: MLP_l1_l2_l3_MC#.pth
