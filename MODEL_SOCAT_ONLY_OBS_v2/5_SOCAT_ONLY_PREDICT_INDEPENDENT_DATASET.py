...
MC_model_dir = (
    ...
    "MODEL_SOCAT_ONLY_OBS_v2/models/30S/MC_ensemble/"
)
...
scaler_path = (
    "/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/"
    "MODEL_SOCAT_ONLY_OBS_v2/models/30S/trained_scaler.joblib"
)

output_csv = f"{MC_model_dir}/independent_predictions/MC_independent_validation_predictions.csv"
...
print(f"[INFO] Found {len(model_files)} ensemble models.")
...
for idx, model_file in enumerate(model_files):
    ...
    # Parse layer sizes from filename: MLP_l1_l2_l3_MCrun.pth
