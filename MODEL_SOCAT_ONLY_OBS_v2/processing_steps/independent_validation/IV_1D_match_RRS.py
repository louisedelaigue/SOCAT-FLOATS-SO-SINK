...
# ===============================================================
# TO LOG IN COPERNICUS MARINE ONLY ONCE RUN THIS BEFORE RUNNING THE SCRIPT IN BASH: copernicusmarine login
...
# === Paths ===
socat_sla_path = ("/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_SOCAT_ONLY_OBS_v2/processing_steps/independent_validation/pco2_independent_validation_data_regridded_SLA.csv")
output_path = ("/remote/unity/bgc-output/DELAIGUE/SOCAT-FLOATS-OSSE/MODEL_SOCAT_ONLY_OBS_v2/processing_steps/independent_validation/pco2_independent_validation_data_regridded_SLA_RRS.csv")
...
grid_center_offset = 0.5          # grid centers at ... -30.5, -31.5, ...
...
# Normalize to month START to match your pipeline
...
for var in variables_all:
    ...
    for year in years:
        ...
        # --- Monthly median with month-START labels (consistent with your other files) ---
        ...
        # --- Aggregate to 1° monthly median (across native pixels inside each 1° cell) ---
        df_rrs = (
        ...
        # Normalize month keys to month START
